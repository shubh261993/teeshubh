    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                bat 'mvn -f C:\\Users\\Shubham\\.jenkins\\workspace\\Cucumber_Pipeline\\optum\\pom.xml compile'
                bat 'mvn -f C:\\Users\\Shubham\\.jenkins\\workspace\\Cucumber_Pipeline\\optum\\pom.xml package'
            }
        }
        stage('Test') {
            steps {
